...
def media_de_recurrencia():
    medias_de_recurrencia = [0] * 256
    for i in range(-127,128):
        recurrencias_i = prob_recurrencia(i)
        media_i = 0
        for j in range(0,300):
            media_i += j * recurrencias_i[j]
        medias_de_recurrencia[i+127] = media_i   
    return medias_de_recurrencia 


print(media_de_recurrencia())
